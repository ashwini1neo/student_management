package com.neosoft.student.basicsecurity;
...
public class AdminSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		.withUser("amit").password(passwordEncoder().encode("amit")).roles("student")
		.and()
		.withUser("navit").password(passwordEncoder().encode("navit")).roles("admin");
